...
if (!window.crypto || !window.crypto.subtle) {
    document.write("<script src=js/crypto-js/core.js><\/script>");
    document.write("<script src=js/crypto-js/crypto-js.js><\/script>");
    document.write("<script src=js/crypto-js/hmac-sha256.js><\/script>");
    document.write("<script src=js/crypto-js/pbkdf2.js><\/script>");
    document.write("<script src=js/crypto-js/lib-typedarrays.js><\/script>");
}
